        ...
        switch (LocationConstants.opponentRace) { //TODO: fix so that bunker contain can be used vs any race with code 1 or 2
            case TERRAN:
                if (BunkerContain.proxyBunkerLevel == 2) {
                    Ketroc.purchaseQueue.add(new PurchaseStructure(Units.TERRAN_SUPPLY_DEPOT));
                    Ketroc.purchaseQueue.add(new PurchaseStructure(BunkerContain.repairScvList.get(0).unit(), Units.TERRAN_BARRACKS, LocationConstants.proxyBarracksPos));
                    ...
                    Ketroc.purchaseQueue.add(new PurchaseStructure(Units.TERRAN_BUNKER, LocationConstants.BUNKER_NATURAL));
...
//                            : LocationConstants.FACTORY;
                    ...
                    Ketroc.purchaseQueue.add(new PurchaseStructure(Units.TERRAN_ENGINEERING_BAY));
                    Ketroc.purchaseQueue.add(new PurchaseStructure(Units.TERRAN_FACTORY, factoryPos));
                    Ketroc.purchaseQueue.add(new PurchaseStructure(Units.TERRAN_SUPPLY_DEPOT));
                    Ketroc.purchaseQueue.add(new PurchaseStructure(Units.TERRAN_REFINERY));
                    Ketroc.purchaseQueue.add(new PurchaseStructure(Units.TERRAN_SUPPLY_DEPOT));
                }
                    ...
                    Ketroc.purchaseQueue.add(new PurchaseStructure(Units.TERRAN_COMMAND_CENTER));
                    Ketroc.purchaseQueue.add(new PurchaseStructure(Units.TERRAN_BUNKER, LocationConstants.BUNKER_NATURAL));
                    Ketroc.purchaseQueue.add(new PurchaseStructure(Units.TERRAN_SUPPLY_DEPOT));
                    ...
                    if (LocationConstants.reaperBlock3x3s.size() >= 2) {
                        ...
                        if (LocationConstants.reaperBlock3x3s.size() == 3) {
                            Ketroc.purchaseQueue.add(new PurchaseStructure(Units.TERRAN_BUNKER, LocationConstants.reaperBlock3x3s.get(2)));
                        }
                    }
            ...
            case PROTOSS:
                if (BunkerContain.proxyBunkerLevel != 0) {
                    Ketroc.purchaseQueue.add(new PurchaseStructure(Units.TERRAN_SUPPLY_DEPOT, LocationConstants.WALL_2x2)); //WALL_2x2
                    ...
                    Ketroc.purchaseQueue.add(new PurchaseStructure(Units.TERRAN_REFINERY));
                    Ketroc.purchaseQueue.add(new PurchaseStructure(Units.TERRAN_COMMAND_CENTER));
                    Ketroc.purchaseQueue.add(new PurchaseStructure(Units.TERRAN_BARRACKS));
                    Ketroc.purchaseQueue.add(new PurchaseStructure(Units.TERRAN_ENGINEERING_BAY));
                    Ketroc.purchaseQueue.add(new PurchaseStructure(Units.TERRAN_REFINERY));
